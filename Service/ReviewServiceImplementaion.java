...
public class ReviewServiceImplementaion implements ReviewService {
	...
	public ReviewServiceImplementaion(ReviewRepository reviewRepository,ProductService productService,
	...
	public List<Review> getAllReview(Long productId) {
		...
		return reviewRepository.getAllProductsReiew(productId);
	}
